 ...
 *     };
 *
 *     private String[] types = { "Стандартный", "VR-квест", "Одиночный", "На двоих", "Перформанс", "Перформанс на двоих", "Одиночный перформанс" };
 *
 *     private int[][] cq = {
 *             {6, 0},
 *             {6, 1},
 ...
 *     };
 *
 *     private String[] categories = {"Для взрослых", "Страшное", "Бросающие в дрожь", "Детское", "С актерами", "Для большой компании", "Топ 10", "Мистические", "Будущее", "Высокий IQ", "На скорость", "Историческое", "Атмосферное", "Хороший сюжет", "Веселое", "Юрский период", "Логическое" };
 *
 ...
 *     };
 *
 *     private String[] methods = {"YooMoney", "Сбербанк", "Тинькофф", "WebMoney", "Qiwi", "Альфа-Банк", "Visa", "Mastercard", "Яндекс.Деньги", "PayPal"};
 *
